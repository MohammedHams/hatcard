    ...
    <div class="row g-5 g-xl-8">
        <div class="col-xl-4">
            ...
            <div class="card bg-light-success card-xl-stretch mb-xl-8">
                ...
                <div class="card-body my-3">
                    <a href="#" class="card-title fw-bolder text-success fs-5 mb-3 d-block">مجموع المبيعات</a>
                    <div class="py-1">
                        <span class="text-dark fs-1 fw-bolder me-2">{{$totalSales}}</span>
                        <span class="fw-bold text-muted fs-7">شيكل</span>
                    </div>
        ...
        <div class="col-xl-4">
            ...
            <div class="card bg-light-warning card-xl-stretch mb-xl-8">
                <!--begin::Body-->
                <div class="card-body my-3">
                    <a href="#" class="card-title fw-bolder text-warning fs-5 mb-3 d-block">عدد البطاقات المباعة</a>
                    <div class="py-1">
                        <span class="text-dark fs-1 fw-bolder me-2">{{$totalPaidCards}}</span>
                        <span class="fw-bold text-muted fs-7">بطاقة</span>
                    </div>
            ...
            <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body my-3">
                    ...
                    <div class="py-1">
                        ...
                        <span class="fw-bold text-muted fs-7">{{$totalSales * 15/100}} شيكل </span>
                    </div>
        ...
        <div class="col-xl-3">
            ...
            <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{$totalNetworks}}</div>
                    <div class="fw-bold text-gray-400">عدد الشبكات</div>
                </div>
                <!--end::Body-->
            </a>
        ...
        <div class="col-xl-3">
            ...
            <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{$totalCategory}}</div>
                    <div class="fw-bold text-gray-100">عدد التصنيفات</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
        ...
        <div class="col-xl-3">
            ...
            <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$totalCard}}</div>
                    <div class="fw-bold text-white">عدد البطاقات المتبقية</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
        ...
        <div class="col-xl-3">
            ...
            <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$totalUploadedCard}}</div>
                    <div class="fw-bold text-white">مجموع البطاقات التي تم رفعها</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
