...
<button type="button" data-title="تصنيفات الشبكة" data-size="modal-xl"  href="{!! route('card-category.index', ['id' => $id, 'is_view' => 1]) !!}"
        class="btn btn-warning btn-sm m-1 OpenModal-lv-2">
